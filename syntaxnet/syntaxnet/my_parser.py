...
TASK_CONTEXT = '/home/chunfengh/models/syntaxnet/syntaxnet/models/parsey_universal/context.pbtxt'
...
def main(unused_argv):
  with tf.Session() as tokenizer_sess:
    tokenizer = ParserEval(tokenizer_sess,
